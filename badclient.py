...
order = input("Welcome to JustHungry, what do you want to order?\n")
name = input("What is your name?")
postcode = input("What is your poscode?")

print("We are trying to execute the command")

fEnd = Pyro4.Proxy("PYRONAME:front_end")
try:
    print(fEnd.setOrder([order],10,strftime("%Y-%m-%d %H:%M:%S", gmtime())))
    print("your order was passed correctly")
except:
    print("we were not able to pass your command")